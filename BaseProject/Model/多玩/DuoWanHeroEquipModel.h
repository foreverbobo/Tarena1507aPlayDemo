...
@class EquipDataModel;
@interface DuoWanHeroEquipModel : BaseModel

@property (nonatomic, strong) NSArray *heroEquipArray;

@end
@interface EquipModel:BaseModel
